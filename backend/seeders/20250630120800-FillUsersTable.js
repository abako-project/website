  ...
  up: async (queryInterface, Sequelize) => {
    ...
    const developers = [
      {email: 'daniela@sitio.es', name: "Daniela", address: "xxxxx1", bio: "Madrileña",
        skillIds: [1,2,3], roleId: 1, proficiencyId: 1, attachment: "d1.jpeg"},
      {email: 'denisse@aqui.es', name: "Denisse", address: "xxxxx2", bio: "Autodidacta",
        skillIds: [1,3], roleId: 2, proficiencyId: 3, attachment: "d2.jpeg"},
      {email: 'dolores@alli.es', name: "Dolores", address: "xxxxx3", bio: "Grandes éxito",
        skillIds: [3],roleId: 3, proficiencyId: 2, attachment: "d3.jpeg"},
      {email: 'deborah@sitio.es', name: "Deborah", address: "xxxxx4", bio: "Becaria eterna",
        skillIds: [1,4], roleId: 2, proficiencyId: 1, attachment: "d4.jpeg"},
      {email: 'diana@sitio.es', name: "Diana", address: "xxxxx5", bio: "Siempre lo mismo",
        skillIds: [], roleId: 1, proficiencyId: 3, attachment: "d5.jpeg"}
    ];
    ...
    for (const {email, name, address, bio, roleId, proficiencyId, skillIds, attachment} of developers) {
      try {
        const user = await User.create({email});
